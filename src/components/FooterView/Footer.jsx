        ...
        <footer className="bg-[#212121] w-full pb-8 overflow-x-hidden">
            ...
            <div className="flex flex-wrap lg:justify-between">
                ...
                <section className="2xl:w-[33%] lg:w-[50%] pl-4 flex flex-col gap-4 items-center ">
                    <img className="w-20 h-20 mt-2" src="./vero-morgade-NBG.png" alt="" />
                    <h2 className="text-white pt-2">Dra. Verónica Morgade</h2>
                    <h2 className="text-white pt-2">Mendoza 1667 Quo Container Center</h2>
                    <h2 className="text-white pt-2">Ingeniero Maschwitz CP:1623</h2>
                    <h2 className="text-white pt-2">Buenos Aires, Argentina</h2>
                    <h2 className="text-white pt-2">Piso 1 Local 17</h2>
                </section>

                <section className="2xl:w-[33%] lg:w-[50%] flex flex-col jutify-start items-center gap-8 ">
                    <h2 className="mt-6 text-white text-2xl">Veni a Visitarnos!</h2>
                ...
                <section className="2xl:pl-36 2xl:w-[33%] xl:mt-12 lg:w-[50%] mt-2">
                    ...
                    <ul className="gap-4 h-auto xl:w-[50%]
                        ...
                        <li className="w-[100%] 2xl:w-auto h-10 relative inline-block text-gray-700 
                            ...
                            hover:before:left-0
                            hover:before:w-full">
                            <a className="w-full h-full text-white flex items-center gap-8 text-xl italic  transition-transform duration-300 hover:scale-101" href="https://wa.me/5491168638712?text=¡Hola%20dra.%20Morgade!">
